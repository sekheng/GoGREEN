...
public class AnimationComponent extends Component {
    ...
    //BitComponent bitComponent = (BitComponent)owner_.getComponent("Ze Images");
    public AnimationComponent(Bitmap bitmap,int x, int y, float fps, int frameCount, int startFrame, int endFrame)
    {
        overtime = fps;
        name_ = "zeAnimations";;
        this.bitmap = bitmap;
